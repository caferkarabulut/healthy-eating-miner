from sqlalchemy import String, Integer, DateTime, Float, Boolean, Text, ForeignKey, Date, func
...
class AIInteraction(Base):
    ...
    suggested_meal_ids: Mapped[str] = mapped_column(Text)
    created_at: Mapped[DateTime] = mapped_column(DateTime, server_default=func.now(), nullable=False)
...
class UserGoals(Base):
    ...
    goal_type: Mapped[str] = mapped_column(String(50), default="maintain")
