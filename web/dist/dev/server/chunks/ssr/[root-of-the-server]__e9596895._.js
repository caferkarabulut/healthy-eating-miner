...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        setLoading(true);
        const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["register"])(email, password);
        if (ok) {
            setSuccess(true);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e9596895._.js.map